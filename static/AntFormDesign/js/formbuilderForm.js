...
DEFFLD = {
    ...
    fieldActions: '<div class="fieldActions hide"><i title="复制 fieldActions里" href="#" class="iconfont faDup">&#xe60b;</i><i title="删除" href="#" class="iconfont faDel">&#xe619;</i></div>',
	...
	//item_antDropdown: '<li><input name="CHKED"value="1"class="radio"type="radio"title="默认选中此择项"/><input name="VAL"type="text"class="sl"/><a class="iconfont ant-icononly-add"title="添加一个新的选择项">&#xe60b;</a><a class="iconfont ant-icononly-del"title="删除此选择项">&#xe619;</a><a class="icononly-mov iconfont"title="排序">&#xe63d;</a><a class="icononly-limit iconfont"title="添加提交次数限制">&#xe632;</a></li>',    
	//item_antDropdown: '<li><input name="CHKED"value="1"class="radio"type="radio"title="默认选中此择项"/><input name="VAL"type="text"class="sl"/><a class="iconfont ant-icononly-add"title="添加一个新的选择项">&#xe60b;</a><a class="iconfont ant-icononly-del"title="删除此选择项">&#xe619;</a><a class="icononly-mov iconfont"title="排序">&#xe63d;</a><a class="icononly-limit iconfont"title="添加提交次数限制">&#xe632;</a></li>',    
	//item_antDropdown: '<span><input type="radio" disabled="disabled" /><label></label></span>',
     item_antDropdown: '<li><input name="CHKED" value="1" class="radio" type="radio" title="默认选中此择项" /><div class="item-upload"><span>上传图片<br>(限1MB)</span><img class="img hide" style="width:60px;"/></div><input name="VAL" type="text" class="xs"/><a class="ant-icononly-add iconfont icon-pos" title="添加一个新的选择项">&#xe60b;</a><a class="ant-icononly-del iconfont icon-pos" title="删除此选择项">&#xe619;</a><a class="icononly-mov iconfont icon-pos" title="排序">&#xe63d;</a><a class="icononly-limit iconfont icon-pos" title="添加提交次数限制">&#xe632;</a></li>',
	...
	text: {
        ...
        html: '<label class="desc"><span class="req hide"> *</span></label> <input type="text" disabled="disabled" maxlength="50" class="input" /><i class="iconfont qrinput hide">&#xe67d;</i>',
		json: '({LBL:"单行文本1",TYP:"text",FLDSZ:"m",REQD:"0",UNIQ:"0",SCU:"pub",IDD:"1234"})',
        holder: '<li class="field prefocus" style="height:71px;width:97%"></li>'
    },
	text2: {
        //html: '<label class="desc"><span class="req hide"> *</span></label><div class="content textcontent"><input type="text" disabled="disabled" maxlength="30" class="input" />2322222222<input type="text" disabled="disabled" maxlength="30" class="input" /><input type="text" disabled="disabled" maxlength="30" class="input" /><i class="iconfont qrinput hide">&#xe67d;</i></div>',
        html: '<span class="req hide"> *</span><div class="content textcontent"><Col><Row>1</Row><Row>2</Row><Row>3</Row></Col></i></div>',
		json: '({LBL:"单行文本2",TYP:"text2",FLDSZ:"m",REQD:"0",UNIQ:"0",SCU:"pub"})',
        holder: '<li class="field prefocus" style="height:71px;width:97%"></li>'
    },
...
/*     textarea: {
	...
	antRow: { /*  likert */
        ...
        json: '({LBL:"antRow标签",TYP:"antRow",REQD:"0",HDNM:"0",SCU:"pub",CSS:"",ITMS:[{LBL:"行标签 1",ITMS:[{VAL:"列标签 1",CHKED:"0"},{VAL:"列标签 2",CHKED:"0"},{VAL:"列标签 3",CHKED:"0"},{VAL:"列标签 4",CHKED:"0"}]},         {LBL:"行标签 2",ITMS:[{VAL:"列标签 1",CHKED:"0"},{VAL:"列标签 2",CHKED:"0"},{VAL:"列标签 3",CHKED:"0"},{VAL:"列标签 4",CHKED:"0"}]},         {LBL:"行标签 3",ITMS:[{VAL:"列标签 1",CHKED:"0"},{VAL:"列标签 2",CHKED:"0"},{VAL:"列标签 3",CHKED:"0"},{VAL:"列标签 4",CHKED:"0"}]}]})',
        holder: '<li class="field prefocus" style="height:184px;width:97%"></li>'
    },
    antButton: {  /*  text  .goal 就是数据*/
        //html: '<label class="desc"><span class="req hide"> *</span></label> <div class="content textcontent"><input type="text" disabled="disabled" maxlength="255" class="input" /><i class="iconfont qrinput hide">&#xe67d;</i></div>',
        html: '<label class="desc"><span class="req hide"> *</span></label> <input  class="goal" type="button"  value ="antButton"></input><i class="iconfont qrinput hide">&#xe67d;</i>',
		json: '({"LBL":"antButton","TYP":"antButton","FLDSZ":"m","REQD":"0","UNIQ":"0","SCU":"pub","Aid":"antButton","Content":"antButton"})',
        //htmlAnt: '<div><Button  typeAnt="" htmlType="" icon="" shape="" size="" loading="" onClick="">htmlAnt Button</Button></div>',
		htmlAnt: '<Button>htmlAnt Button</Button>',
		holder: '<li class="field prefocus" style="height:71px;width:97%"></li>'
	  ...
	  antAffix: {  /*  text  .goal 就是数据*/
        html: '<label class="desc"><span class="req hide"> *</span></label> <input  class="goal" type="button"  value ="antAffix"></input><i class="iconfont qrinput hide">&#xe67d;</i>',
		json: '({"LBL":"antAffix","TYP":"antAffix","FLDSZ":"m","REQD":"0","UNIQ":"0","SCU":"pub","Aid":"antAffix","Content":"antAffix"})',
        htmlAnt: '<Affix>antAffix</Affix>',
		holder: '<li class="field prefocus" style="height:71px;width:97%"></li>'
...
/* 	  dropdown: {
    ...
    antBreadcrumb: {  /* 多级下拉框*/
		html: '<label class="desc"><span class="req hide"> *</span></label><div class="content"><select disabled="disabled" class="m input"></select></div>',
        json: '({LBL:"下拉框",TYP:"dropdown2",FLDSZ:"m",REQD:"0",SCU:"pub",INSTR:"",CSS:"",ITMS:[{VAL:"选项 1",CHKED:"0"},{VAL:"选项 2",CHKED:"0"},{VAL:"选项 3",CHKED:"0"}]})',
        htmlAnt: '<Affix>antAffix</Affix>',
		holder: '<li class="field prefocus" style="height:71px;width:97%"></li>',
		
    },
	antDropdown: {  /*  text  .goal 就是数据*/
       html: '<label class="desc"><span class="req hide"> * </span></label><div class="content"><span><input type="checkbox" disabled="disabled"><label>选项 1</label></span></div>',
		json:   '({"LBL":"antDropdown","TYP":"antDropdown","FLDSZ":"m","REQD":"0","UNIQ":"0","SCU":"pub","Aid":"antDropdown","Content":"antDropdown",ITMS:[{VAL:"选项 1",CHKED:"0"}]})',
        //json: '({LBL:"下拉框",TYP:"dropdown",FLDSZ:"m",REQD:"0",SCU:"pub",INSTR:"",CSS:"",ITMS:[{VAL:"选项 1",CHKED:"0"},{VAL:"选项 2",CHKED:"0"},{VAL:"选项 3",CHKED:"0"}]})',
        htmlAnt: '<Dropdown overlay={menu} trigger={[click]}><Menu><Menu.Item><a>选项 1</a></Menu.Item></Menu> <a className="ant-dropdown-link" href="#">   Click me <Icon type="down" /> </a>',
		holder: '<li class="field prefocus" style="height:71px;width:97%"></li>'
...
function createItems(f, b, d) {
    ...
    a = {
		...
		antDropdown: DEFFLD.item_antDropdown,
    };
    if (a[b] === undefined) {
        return
    }
...
function setPropertieValues(c) {
 ...
 if (c.FormItem) {
	...
	if (c.FormItem.name) {
		$('#FormItemname').val(c.FormItem.name);
		}


	if (c.FormItem.colon) {
		$('#FormItemcolon').val(c.FormItem.colon);
	}
	if (c.FormItem.extra) {
		$('#FormItemextra').val(c.FormItem.extra);
	}
	if (c.FormItem.label) {
		$('#FormItemlabel').val(c.FormItem.label);
	}
	if (c.FormItem.labelCol) {
		$('#FormItemlabelCol').val(c.FormItem.labelCol);
	}
	if (c.FormItem.wrapperCol) {
		$('#FormItemwrapperCol').val(c.FormItem.wrapperCol);
	}
	if (c.FormItem.type) {
		$('#FormItemtype').val(JSON.stringify(c.FormItem.type));// 下面还有子节点
	}



if (c.FormItem.getFieldDecorator) {
if (c.FormItem.getFieldDecorator.rules) {
	$('#Rulesenum').val(c.FormItem.getFieldDecorator.rules.enum);
}
if (c.FormItem.getFieldDecorator.rules) {
	$('#Ruleslen').val(c.FormItem.getFieldDecorator.rules.len);
}
if (c.FormItem.getFieldDecorator.rules) {
	$('#Rulesmax').val(c.FormItem.getFieldDecorator.rules.max);
}
if (c.FormItem.getFieldDecorator.rules) {
	$('#Rulesmessage').val(c.FormItem.getFieldDecorator.rules.message);
}
if (c.FormItem.getFieldDecorator.rules) {
	$('#Rulesmin').val(c.FormItem.getFieldDecorator.rules.min);
}
if (c.FormItem.getFieldDecorator.rules) {
	$('#Rulespattern').val(c.FormItem.getFieldDecorator.rules.pattern);
}
if (c.FormItem.getFieldDecorator.rules) {
	$('#Rulesrequired').val(c.FormItem.getFieldDecorator.rules.required);
}
if (c.FormItem.getFieldDecorator.rules) {
	$('#Rulestransform').val(c.FormItem.getFieldDecorator.rules.transform);
}
if (c.FormItem.getFieldDecorator.rules) {
	$('#Rulestype').val(c.FormItem.getFieldDecorator.rules.type);
}
if (c.FormItem.getFieldDecorator.rules) {
	$('#Rulesvalidator').val(c.FormItem.getFieldDecorator.rules.validator);
}
if (c.FormItem.getFieldDecorator.rules) {
	$('#Ruleswhitespace').val(c.FormItem.getFieldDecorator.rules.whitespace);
}
}
...
function propertyInit() {
    ...
    var e = function (aa, ab) {
        ...
        for (Y = 0, i1 = 0; Y < Z.length; Y++) {
            ...
            if (ab == 'radio' || ab == 'dropdown'/* ||ab == 'antDropdown' */) {
    ...
    A = function (U) {
        ...
        if (F[IDX].TYP === 'radio') {
            ...
            if ((F[IDX].TYP === 'dropdown')/* ||(F[IDX].TYP === 'antDropdown') */) {
	...
	var uContent = function () {	
		...
		var V = $('#f' + IDX),
		content = $(this).val();
		//console.log(' 123:', $('#f' + IDX .goal));
		//console.log('V.filter(".goal"):',V.filter(".goal"));
		$('#f' + IDX +' .goal').val($(this).val());
		
        F[IDX].Content = $(this).val();
        CHANGED = true
    };
...
var uAid = function() {
	var jQObj = $(Ant[IDX]);
	jQObj.attr("id", $.trim($(this).val()));
	Ant[IDX] = jQObj.prop("outerHTML");
	F[IDX].id = $.trim($(this).val());
	CHANGED = true
};
$('#Aid').bind({
	keyup: uAid,
	...
	var uButtontype = function () {	
		console.log('Start Ant[IDX]:',Ant[IDX]);
		var jQObj=$(Ant[IDX])
		console.log('Start jQObj.html():',jQObj.html());
		console.log('Start jQObj.prop("outerHTML"):',jQObj.prop("outerHTML"));
		jQObj.attr("typeAnt", $.trim($(this).val()));
		jQObj.attr("id", $.trim($(this).val()));
		//jQObj.setAttribute("type","hidden")
		Ant[IDX] = jQObj.prop("outerHTML");
		console.log("jQObj.html():",jQObj.html());
		console.log("jQObj:",jQObj);
		console.log("Ant[IDX]",Ant[IDX]);
	...
	var uButtonsize = function () {	
		var jQObj=$(Ant[IDX])
		jQObj.attr("size", $.trim($(this).val()));
		Ant[IDX] = jQObj.prop("outerHTML");
        F[IDX].Buttonsize = $.trim($(this).val());
        CHANGED = true
    };
	...
	var uButtonshape = function () {	
		var jQObj=$(Ant[IDX])
		jQObj.attr("shape", $.trim($(this).val()));
		Ant[IDX] = jQObj.prop("outerHTML");
	...
	var uButtonicon = function () {	
		var jQObj=$(Ant[IDX])
		jQObj.attr("icon", $.trim($(this).val()));
		Ant[IDX] = jQObj.prop("outerHTML");
        F[IDX].Buttonicon = $.trim($(this).val());
        CHANGED = true
    };
...
var uButtonloading = function() {
    var jQObj = $(Ant[IDX]) ;
	jQObj.attr("loading", $.trim($(this).val()));
    Ant[IDX] = jQObj.prop("outerHTML");
    F[IDX].Buttonloading = $.trim($(this).val());
    CHANGED = true
};
$('#Buttonloading').bind({
    keyup: uButtonloading,
    change: uButtonloading
});	

var uButtonghost = function() {
	var jQObj = $(Ant[IDX]);
	jQObj.attr("ghost", $.trim($(this).val()));
	Ant[IDX] = jQObj.prop("outerHTML");
	F[IDX].Buttonghost = $.trim($(this).val());
	CHANGED = true
};
$('#Buttonghost').bind({
	keyup: uButtonghost,
...
var uButtonhtmlType = function() {
	var jQObj = $(Ant[IDX]);
	jQObj.attr("htmlType", $.trim($(this).val()));
	Ant[IDX] = jQObj.prop("outerHTML");
	F[IDX].ButtonhtmlType = $.trim($(this).val());
	CHANGED = true
};
$('#ButtonhtmlType').bind({
	keyup: uButtonhtmlType,
	change: uButtonhtmlType
});

var uButtontarget = function() {
	var jQObj = $(Ant[IDX]);
	jQObj.attr("target_href", $.trim($(this).val()));
	Ant[IDX] = jQObj.prop("outerHTML");
	F[IDX].Buttontarget = $.trim($(this).val());
	CHANGED = true
};
$('#Buttontarget').bind({
	keyup: uButtontarget,
	change: uButtontarget
});
...
/* antIcon Start */	
var uIconspin = function() {
	var jQObj = $(Ant[IDX]);
	jQObj.attr("spin", $.trim($(this).val()));
	Ant[IDX] = jQObj.prop("outerHTML");
	F[IDX].Iconspin = $.trim($(this).val());
	CHANGED = true
};
$('#Iconspin').bind({
	keyup: uIconspin,
...
var uStyle = function() {
	var jQObj = $(Ant[IDX]);
	jQObj.attr("style", $.trim($(this).val()));
	Ant[IDX] = jQObj.prop("outerHTML");
	F[IDX].style = $.trim($(this).val());
	CHANGED = true
};
$('#style').bind({
	keyup: uStyle,
...
var uIcontype = function() {
	var jQObj = $(Ant[IDX]);
	jQObj.attr("type", $.trim($(this).val()));
	Ant[IDX] = jQObj.prop("outerHTML");
	F[IDX].Icontype = $.trim($(this).val());
	CHANGED = true
};
$('#Icontype').bind({
	keyup: uIcontype,
...
/* antAffix Start */
var uAffixoffsetBottom = function() {
	var jQObj = $(Ant[IDX]);
	jQObj.attr("offsetBottom", $.trim($(this).val()));
	Ant[IDX] = jQObj.prop("outerHTML");
	F[IDX].AffixoffsetBottom = $.trim($(this).val());
	CHANGED = true
};
$('#AffixoffsetBottom').bind({
	keyup: uAffixoffsetBottom,
	change: uAffixoffsetBottom
});
var uAffixoffsetTop = function() {
	var jQObj = $(Ant[IDX]);
	jQObj.attr("offsetTop", $.trim($(this).val()));
	Ant[IDX] = jQObj.prop("outerHTML");
	F[IDX].AffixoffsetTop = $.trim($(this).val());
	CHANGED = true
};
$('#AffixoffsetTop').bind({
	keyup: uAffixoffsetTop,
	change: uAffixoffsetTop
});
var uAffixtarget = function() {
	var jQObj = $(Ant[IDX]);
	jQObj.attr("target", $.trim($(this).val()));
	Ant[IDX] = jQObj.prop("outerHTML");
	F[IDX].Affixtarget = $.trim($(this).val());
	CHANGED = true
};
$('#Affixtarget').bind({
	keyup: uAffixtarget,
...
var uAffixonChange = function() {
	var jQObj = $(Ant[IDX]);
	jQObj.attr("onChange", $.trim($(this).val()));
	Ant[IDX] = jQObj.prop("outerHTML");
	F[IDX].AffixonChange = $.trim($(this).val());
	CHANGED = true
};
$('#AffixonChange').bind({
	keyup: uAffixonChange,
	change: uAffixonChange
});
/* antAffix End */

/* FormItem Start */

var uFormItemname = function() {
	F[IDX].FormItem.name = $.trim($(this).val());
	CHANGED = true
};
$('#FormItemname').bind({
	keyup: uFormItemname,
	change: uFormItemname
});

var uFormItemcolon = function() {
	F[IDX].FormItem.colon = $.trim($(this).val());
	CHANGED = true
};
$('#FormItemcolon').bind({
	keyup: uFormItemcolon,
	change: uFormItemcolon
});
var uFormItemextra = function() {
	F[IDX].FormItem.extra = $.trim($(this).val());
	CHANGED = true
};
$('#FormItemextra').bind({
	keyup: uFormItemextra,
	change: uFormItemextra
});
var uFormItemlabel = function() {
	F[IDX].FormItem.label = $.trim($(this).val());
	CHANGED = true
};
$('#FormItemlabel').bind({
	keyup: uFormItemlabel,
	change: uFormItemlabel
});
var uFormItemlabelCol = function() {
	F[IDX].FormItem.labelCol = $.trim($(this).val());
	CHANGED = true
};
$('#FormItemlabelCol').bind({
	keyup: uFormItemlabelCol,
	change: uFormItemlabelCol
});
var uFormItemwrapperCol = function() {
	F[IDX].FormItem.wrapperCol = $.trim($(this).val());
	CHANGED = true
};
$('#FormItemwrapperCol').bind({
	keyup: uFormItemwrapperCol,
...
var uRulesenum = function() {
	F[IDX].FormItem.getFieldDecorator.rules.enum = $.trim($(this).val());
	CHANGED = true
};
$('#Rulesenum').bind({
	keyup: uRulesenum,
...
var uRuleslen = function() {
	F[IDX].FormItem.getFieldDecorator.rules.len = $.trim($(this).val());
	CHANGED = true
};
$('#Ruleslen').bind({
	keyup: uRuleslen,
...
var uRulesmax = function() {
	F[IDX].FormItem.getFieldDecorator.rules.max = $.trim($(this).val());
	CHANGED = true
};
$('#Rulesmax').bind({
	keyup: uRulesmax,
...
var uRulesmessage = function() {
	F[IDX].FormItem.getFieldDecorator.rules.message = $.trim($(this).val());
	CHANGED = true
};
$('#Rulesmessage').bind({
	keyup: uRulesmessage,
	change: uRulesmessage
});
var uRulesmin = function() {
	F[IDX].FormItem.getFieldDecorator.rules.min = $.trim($(this).val());
	CHANGED = true
};
$('#Rulesmin').bind({
	keyup: uRulesmin,
...
var uRulespattern = function() {
	F[IDX].FormItem.getFieldDecorator.rules.pattern = $.trim($(this).val());
	CHANGED = true
};
$('#Rulespattern').bind({
	keyup: uRulespattern,
	change: uRulespattern
});
var uRulesrequired = function() {
	F[IDX].FormItem.getFieldDecorator.rules.required = $.trim($(this).val());
	CHANGED = true
};
$('#Rulesrequired').bind({
	keyup: uRulesrequired,
	change: uRulesrequired
});
var uRulestransform = function() {
	F[IDX].FormItem.getFieldDecorator.rules.transform = $.trim($(this).val());
	CHANGED = true
};
$('#Rulestransform').bind({
	keyup: uRulestransform,
	change: uRulestransform
});
var uRulestype = function() {
	F[IDX].FormItem.getFieldDecorator.rules.type = $.trim($(this).val());
	CHANGED = true
};
$('#Rulestype').bind({
	keyup: uRulestype,
...
var uRulesvalidator = function() {
	F[IDX].FormItem.getFieldDecorator.rules.validator = $.trim($(this).val());
	CHANGED = true
};
$('#Rulesvalidator').bind({
	keyup: uRulesvalidator,
	change: uRulesvalidator
});
var uRuleswhitespace = function() {
	F[IDX].FormItem.getFieldDecorator.rules.whitespace = $.trim($(this).val());
	CHANGED = true
};
$('#Ruleswhitespace').bind({
	keyup: uRuleswhitespace,
	change: uRuleswhitespace
});
...
/*     $('#dateformat').change(function () {
 ...
 $('#itemList>li>a.icononly-limit').live({ // 选择项的隐藏的 下拉选项
        click: function () {
            var W = this,
            U = $(this).parent(),
            X = U.index();
            ...
            if (V.length == 0) {
                var Z = 'lmt' + X;
                var Y = '<div id="' + Z + '" class="limit hide" style="margin-top:5px;"><select class="s" style="margin-left:18px;" name="COMMITLMT"><option value="DAY">每天</option><option value="ALL">累计</option></select> 限制填写 <input class="s number" type="text" name="AMOUNTLMT" maxlength="10"/> 次 target <input class="menuItemTarget" type="text" name="target" /> href <input class="menuItemHref" type="text" name="href" /> rel <input class="menuItemRel" type="text" name="rel" /></div>';
                V = $(Y);
                U.append(V)
            }
            if (V.hasClass('hide')) {
...
/*   $('#itemList>li>div.limit>select, #goodsList>li div[name=\'goods-limit\']>select').live({
    ...
    $('#itemList>li>div.limit>input, #goodsList>li div[name=\'goods-limit\']>input').live({ // 隐藏的单选项的 input被修改,就会启用赋值
        change: function () {
            var U = $(this),
            X = U.parent();
            var ab;
           /*  if (X.attr('name') == 'goods-limit') {
                ...
                ab = X.parent()
          /*   } */
            var Y = ab.index();//Y 为选项的序号
			
			// 变成小写
			var target,href,rel;
			target = X.find("input.menuItemTarget").val();
			href = X.find("input.menuItemHref").val();
			rel =  X.find("input.menuItemRel").val();
			var jQObj=$(Ant[IDX]);
			jQObj.find("menu").children("*:eq("+Y+")").find("a").attr("target",target);
			jQObj.find("menu").children("*:eq("+Y+")").find("a").attr("href",href);
			jQObj.find("menu").children("*:eq("+Y+")").find("a").attr("rel",rel);
			//jQObj.find("menu").append("<Menu.Item>"+menuItemValue+"</Menu.Item>");
	...
	$('a.ant-icononly-del', '#itemList').live({
        //click: DAnt
		 click: function () {
		var X = this,
        U = $(this).parent(),
		...
		//resizeHandle($('#f' + IDX));  这个本来就没有
		// 修改 antDropdown 的antHtml   找到  JQObj  找到$(this)平级的input 将值赋给JQObj.menu  再Ant[IDX] =jQObj.prop("outerHTML")
			var jQObj=$(Ant[IDX]);
			//var menuItem=$(this).siblings("input:eq("+w+")"); // w 为选号的序号
			v//ar menuItemValue=$(this).siblings("input:eq(1)").val();
			// 变成小写
			jQObj.find("menu").children("*:eq("+W+")").remove();
			//jQObj.find("menu").append("<Menu.Item>"+menuItemValue+"</Menu.Item>");
			Ant[IDX] = jQObj.prop("outerHTML");
	...
	*/
    $('#itemList').find('a.icononly-add').live({
	 ...
	 $('#itemList').find('a.ant-icononly-add').live({
        click: function () {
            var V = $('a.ant-icononly-add', '#itemList').index(this);
            var X = $(this).parent().clone();
           /*  X.find(':radio,:checkbox').prop('checked', false);
            X.find('img.img').addClass('hide').attr({
                src: ''
          ...
          /*   delete Y.ITMID;
			...
			// 修改 antDropdown 的antHtml   找到  JQObj  找到$(this)平级的input 将值赋给JQObj.menu  再Ant[IDX] =jQObj.prop("outerHTML")
			var jQObj=$(Ant[IDX]);
			var menuItem=$(this).siblings("input:eq(1)");
			var menuItemValue=$(this).siblings("input:eq(1)").val();
			// 变成小写
			jQObj.find("menu").append("<Menu.Item><a>"+menuItemValue+"</a></Menu.Item>");
			Ant[IDX] = jQObj.prop("outerHTML");
    ...
    var I = function () { // 将Item的值赋值到 $('#f' + IDX).find('div.content span:eq(' + U + ') label')
        ...
        F[IDX].ITMS[U].VAL = $.trim($(this).val());
			...
			//改选项的 Menu.Item(jQuery改为小写了) 中的值
			var jQObj=$(Ant[IDX]);
			jQObj.find("menu").children("*:eq("+U+")").text($(this).val());
			Ant[IDX] = jQObj.prop("outerHTML");		
        CHANGED = true
    };
    ...
    $(':radio', '#itemList').live({ // radio 和itemList的交集 点击就
        click: function () {
	 ...
	 /* $(':radio', '#DropdownitemList').live({
        click: function () {
            var V = $(':radio', '#DropdownitemList').index(this),
            W = $(this).prop('checked');
            $(':radio', '#f' + IDX).prop('checked', false);
            $('select', '#f' + IDX).empty();
            $.each(F[IDX].ITMS, function (Y, X) {
   ...
   /* var q = function () {
    ...
    $('#btnDup,#fields i.faDup').live({
        click: function () {
			...
			XhtmlAnt = JSON.parse(JSON.stringify(Ant[IDX])), // 新加的Ant
            V = $('#f' + IDX).clone();
...
function saveForm(e, f, c) {
	...
	//保存数据 返回guid表示唯一ID
	console.log({ formData: JSON.stringify(M), parameterData: JSON.stringify(F) });
...
function addFieldsInit() {
    ...
    $('#preview').click(function () {
     ...
     $.post("/formdesign/formview", { formData: JSON.stringify(M), parameterData: JSON.stringify(F) });
	...
	$('#preview3').click(function () {
		console.log("Ant:",Ant);
		console.log("JSON.stringify(Ant):",JSON.stringify(Ant));
       // $.post("/CustomFrom/FormDesign/FormView", { formData: JSON.stringify(M), parameterData: JSON.stringify(F) });
	 post('/formdesign/formview3',{ formData: JSON.stringify(M), parameterData: JSON.stringify(F),parameterDataAnt:JSON.stringify(Ant) });
	//post('/formdesign/formview3',{ formData: JSON.stringify(M), parameterData: JSON.stringify(F),parameterDataAnt:Ant}) ; // 这个默认变成小写了
	...
	$('#preview5').click(function () {
		//console.log("Ant:",Ant);
		console.log("JSON.stringify(Ant):",JSON.stringify(Ant));
	 post('/formdesign/formview5',{ formData: JSON.stringify(M), parameterData: JSON.stringify(F) });
	});
...
function createField(r, q) {
    ...
    p.text(q.LBL);
	// 包含的内容 用什么呢?
	pContent=l.find('input');
	pContent.val(q.Content);
