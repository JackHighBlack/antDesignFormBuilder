...
DEFFLD = {
    ...
    text: {
        html: '<label class="desc"><span class="req hide"> *</span></label><div class="content textcontent">111111<input type="text"  maxlength="255" class="input fld" id="text1" /></div>'
    },
	text2: {
        html: '<label class="desc"><span class="req hide"> *</span></label><div class="content textcontent">222222<input type="text"  maxlength="255" class="input fld" id="text2" /></div>'
    },


    number: {
        html: '<label class="desc"><span class="req hide"> *</span></label><div class="content"><input type="text" maxlength="32" class="input fld"  id="number" /></div>'
    },
    textarea: {
...
function createField(r, q, num) {
	...
	input = l.find('input');
	if (q.IDD !== undefined) {
		console.log("p.find('input'):",input,", q.IDD:",q.IDD,",input.attr('id')",input.attr('id'));
        input.attr('id',q.IDD);
		//input.attr('DomIDD1',q.IDD);
    }
    p.text(q.LBL);
    p.append(o);
